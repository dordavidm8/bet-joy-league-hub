...
INSERT INTO social_knowledge_base (title, content, category) VALUES
  ('מהי KickOff', 'KickOff היא פלטפורמת הימורי כדורגל חברתית בעברית. משתמשים מהמרים עם נקודות (לא כסף אמיתי) על משחקי כדורגל, מתחרים בליגות פרטיות עם חברים, ומשתמשים ביועץ AI חכם. האפליקציה כוללת מיני-משחקים יומיים, טריוויה, ובוט WhatsApp.', 'brand'),
