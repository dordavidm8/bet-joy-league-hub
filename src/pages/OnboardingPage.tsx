...
const SCREENS = [
  {
    emoji: "⚽",
    title: "ברוך הבא ל-Kickoff!",
    desc: "הימרו על משחקי כדורגל עם נקודות — בחינם, ללא כסף אמיתי.\nכל משחק הוא הזדמנות לנקודות ולהתחרות עם חברים.",
    sub: "קיבלת 500 נקודות פתיחה!",
    subColor: "text-green-600",
  },
  {
    emoji: "🎯",
    title: "איך מהמרים?",
    desc: "בחרו משחק, ענו על שאלות ההימור (מי ינצח? כמה שערים?) וקבעו כמה נקודות אתם מהמרים.\nנכון? קיבלתם נקודות. לא נכון? הימרתם הפעם הבאה.",
    sub: "Live betting זמין עד דקה 75 (עם קנס הדרגתי)",
    subColor: "text-orange-500",
  },
  {
    emoji: "🏆",
    title: "ליגות פרטיות",
    desc: "צרו ליגה עם חברים, קבעו דמי כניסה ופצו את הזוכים.\nהזמינו חברים בקוד ייחודי, צברו נקודות לאורך העונה.",
    sub: "הפנו חבר — קבלו 1,000 נקודות בונוס!",
